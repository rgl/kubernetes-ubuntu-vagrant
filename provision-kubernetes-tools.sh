...
kubeadm_version="${1:-1.16.0-00}"; shift || true # NB execute apt-cache madison kubeadm to known the available versions.
kubelet_version="${1:-1.16.0-00}"; shift || true # NB execute apt-cache madison kubelet to known the available versions.
kubectl_version="${1:-1.16.0-00}"; shift || true # NB execute apt-cache madison kubectl to known the available versions.
